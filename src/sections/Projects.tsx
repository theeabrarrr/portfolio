...
const projects = [
  {
    ...
    tech: ['Next.js', 'Supabase', 'Tailwind', 'Shadcn UI', 'RLS'],
    description: 'A high-scale SaaS distribution platform with strict multi-tenant isolation, automated credit tracking, and real-time driver analytics.',
    image: '/images/project-lpg.png',
    liveUrl: 'https://lpg-connect.vercel.app/',
  ...
  },
  {
    ...
    tech: ['React', 'Vite', 'Supabase', 'Recharts'],
    description: 'An enterprise-grade management tool featuring automated attendance tracking, custom cycle management, and a real-time fuel management dashboard.',
  ...
  },
  {
    ...
    description: 'A custom web application for streamlined property management, centralized utility tracking, and automated financial reporting with multi-role authentication.',
  ...
  },
  {
    ...
    description: 'A high-performance personal branding platform showcasing advanced UI/UX principles, smooth transitions, and optimized for Core Web Vitals.',
...
const categories = ['All', 'Multi-Tenant SaaS', 'HR & Fleet Management', 'Property Management', 'Professional Branding'];
